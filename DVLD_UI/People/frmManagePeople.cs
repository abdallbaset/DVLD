    ...
    public partial class frmManagePeople : Form
    {
        ...
        private void _FormatDataGridViewColumn()
        {
            if (dgv_ListPeople.Rows.Count > 0)
            {
                 ...
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["PersonID"], "ID", 90);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["NationalNo"], "National No", 130);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["FirstName"], "First Name", 140);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["SecondName"], "Second Name", 140);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["ThirdName"], "Third Name", 120);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["LastName"], "Last Name", 140);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["DateOfBirth"], "Date Of Birth", 110);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["Gendor"], "Gendor", 90);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["Phone"], "Phone", 120);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["Email"], "Email", 200);
                 clsUtil.ConfigureColumn(dgv_ListPeople.Columns["Nationality"], "Nationality", 150);
            }
        }
